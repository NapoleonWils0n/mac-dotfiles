...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dracula-theme haskell-mode csv-mode ob-async flycheck git-auto-commit-mode powerline ox-pandoc markdown-mode magit evil-surround evil-leader emmet-mode elpy undo-tree which-key)))
